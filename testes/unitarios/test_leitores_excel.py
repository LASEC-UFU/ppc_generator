...
def test_carregar_matriz_sem_aba_enfases_formativas(tmp_path):
    """Aba ``EnfasesFormativas`` é opcional — ausência vira catálogo vazio,
    sem erro (mesmo tratamento das demais abas de catálogo opcionais)."""
