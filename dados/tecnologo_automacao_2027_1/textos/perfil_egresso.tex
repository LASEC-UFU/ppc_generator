...
O \ppccurso constitui uma formação tecnológica completa, autônoma e terminal: sua conclusão não representa uma etapa intermediária, uma certificação parcial ou uma interrupção da Engenharia de Automação, Robótica e Inteligência Artificial, mas a integralização de uma graduação com identidade formativa, perfil de egresso e terminalidade profissional próprios (\autoref{sec:distincao_perfis}, \autoref{chp:abi}).

Este capítulo descreve exclusivamente o perfil profissional do egresso do \ppccurso. Embora o \ppccurso integre uma Área Básica de Ingresso (ABI) com o curso de Engenharia de Automação, Robótica e Inteligência Artificial, e os cinco primeiros períodos comuns às duas graduações desenvolvam competências e conteúdos de fundamentação compartilhados (\autoref{sec:integracao_pedagogica_abi}), cada curso mantém perfil de egresso próprio: o perfil descrito a seguir corresponde integralmente ao \ppcgrau em Automação Industrial, e não se confunde com o perfil profissional do(a) engenheiro(a) formado(a) pelo curso de Engenharia de Automação, Robótica e Inteligência Artificial, definido no respectivo PPC. O estudante que concluir as duas graduações (\autoref{chp:abi}) deverá atender, separadamente, ao perfil e aos requisitos formativos de cada uma delas.
...
Tanto o(a) \ppctitulacao quanto o(a) egresso(a) do curso de Engenharia de Automação, Robótica e Inteligência Artificial, integrante da mesma Área Básica de Ingresso (\autoref{chp:abi}; \autoref{sec:distincao_perfis}), podem estar vinculados ao Sistema CONFEA/CREA. Pertencer ao mesmo sistema profissional, todavia, não significa possuir o mesmo título ou as mesmas atribuições: cada curso confere um título profissional distinto, e as atribuições correspondentes são analisadas pelo Sistema CONFEA/CREA conforme a formação efetivamente demonstrada — para a qual são relevantes o PPC, a matriz curricular, as ementas, as cargas horárias e as atividades práticas de cada curso, além do perfil do egresso aqui descrito. O egresso deste curso poderá requerer registro no Sistema CONFEA/CREA, observados o título profissional correspondente, a regulamentação vigente e a análise da formação efetivamente desenvolvida no curso — não se promete, neste PPC, atribuição profissional automática ou idêntica à do(a) engenheiro(a) formado(a) pelo curso de Engenharia de Automação, Robótica e Inteligência Artificial.
