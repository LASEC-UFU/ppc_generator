...
\label{chp:acompanhamento_egresso}
...
\section{Acompanhamento na Área Básica de Ingresso (ABI)}

Como o \ppccurso integra a ABI com o curso de Engenharia de Automação, Robótica e Inteligência Artificial (\autoref{chp:abi}), o acompanhamento de egressos deste curso diferencia, dentre os estudantes que passaram pela ABI, ao menos os seguintes perfis:

\begin{itemize}
    \item egressos que concluíram apenas o \ppccurso, sem solicitar permanência de vínculo para a Engenharia de Automação, Robótica e Inteligência Artificial;
    \item egressos que concluíram o \ppccurso e solicitaram permanência de vínculo para prosseguir na Engenharia de Automação, Robótica e Inteligência Artificial (\autoref{sec:permanencia}), estando essa segunda formação ainda em andamento; e
    \item egressos que concluíram as duas graduações integrantes da ABI, obtendo os dois diplomas (\autoref{sec:diplomas}).
\end{itemize}

Este PPC concentra seu acompanhamento no perfil profissional do(a) Tecnólogo(a) em Automação Industrial (\autoref{chp:perfil_egresso}), próprio deste curso, sem ignorar a possibilidade de continuidade acadêmica na Engenharia de Automação, Robótica e Inteligência Artificial: os egressos que optarem por essa continuidade são acompanhados também quanto a essa trajetória, mas o acompanhamento do perfil profissional específico da Engenharia é tratado no respectivo PPC.
