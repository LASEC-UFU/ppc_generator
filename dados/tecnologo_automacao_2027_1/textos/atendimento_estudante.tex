...
% Suporte à vida acadêmica & Coordenação do Curso de \ppccurso (FEELT) & \url{https://www.feelt.ufu.br/graduacao/engenharia-de-computacao}\\
...
O curso de \ppccurso da UFU compreende que a excelência acadêmica exige um ambiente de aprendizagem acolhedor, saudável, diverso e acessível. Por isso, desenvolve e apoia ações de atenção estudantil em articulação com a Faculdade de Engenharia Elétrica (FEELT) e os órgãos centrais da universidade.
