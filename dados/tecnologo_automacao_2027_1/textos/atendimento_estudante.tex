...
Como o \ppccurso integra a ABI com o curso de Engenharia de Automação, Robótica e Inteligência Artificial (\autoref{chp:abi}), a Coordenação do Curso e a Direção da FEELT prestam, ao longo dos cinco primeiros períodos, orientação acadêmica voltada especificamente a essa organização, incluindo:
...
\begin{itemize}
    ...
    \item a orientação sobre o procedimento de permanência de vínculo, para o estudante que desejar, após concluir a primeira graduação, prosseguir na outra formação integrante da ABI (\autoref{sec:permanencia}); e
    \item o acompanhamento do estudante que optar pela continuidade na segunda graduação, inclusive quanto ao aproveitamento dos componentes comuns e às equivalências curriculares aplicáveis (\autoref{sec:equivalencias_abi}).
\end{itemize}
