...
O \ppccurso da Universidade Federal de Uberlândia adota uma concepção pedagógica centrada na formação integral do(a) estudante, combinando o desenvolvimento de conhecimentos técnico-aplicados com habilidades práticas, atitudes éticas e capacidades reflexivas. As diretrizes metodológicas são pautadas por uma abordagem orientada por competências, conforme as Diretrizes Curriculares Nacionais Gerais para a Educação Profissional e Tecnológica~\cite{cne_cp_1_2021}, valorizando o protagonismo discente, a interdisciplinaridade e a articulação entre teoria e prática profissional.
...
O \ppccurso é organizado na ABI com o curso de Engenharia de Automação, Robótica e Inteligência Artificial (\autoref{chp:abi}). Do ponto de vista pedagógico, essa organização estrutura-se em duas fases articuladas entre si:
...
% REVISAR: a norma institucional da UFU específica sobre oferta de componentes EaD em cursos presenciais ainda está em tramitação no CONGRAD e não foi publicada até a elaboração deste PPC (\texttt{oferta.status\_validacao\_institucional: pendente}, aba \texttt{Perfil} da matriz curricular) — a oferta de EaD deste curso apoia-se, por ora, exclusivamente na norma federal (Decreto nº 12.456/2025 e Portaria MEC nº 378/2025).
