...
Com base nas resoluções e decretos configurados na aba \texttt{Legislacao} da matriz curricular, apresentam-se a seguir os quadros que identificam os componentes curriculares que contemplam os temas transversais obrigatórios.
...
Com base na Resolução CNE/CES nº 5/2016 (Diretrizes Curriculares Nacionais para os cursos de Computação) e no \textit{Computing Curricula 2020}~\cite{acm_cc2020}, apresentam-se a seguir os quadros que relacionam cada conteúdo curricular obrigatório, definido na aba \texttt{Conteudos} da matriz curricular, aos componentes curriculares que o desenvolvem.
...
Os quadros a seguir relacionam cada competência definida em \texttt{perfil.competencias} (\texttt{perfil.yaml}) aos componentes curriculares que a desenvolvem.
