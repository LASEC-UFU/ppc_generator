...
\textcolor{red}{[A CARGA HORÁRIA OPTATIVA MÍNIMA DESTE CURSO (\textbf{\input{gerado/par_carga_horaria_optativa}}) NÃO É MAIS UM PARÂMETRO SEPARADO NA ABA \texttt{PERFIL} — É LIDA DIRETAMENTE DO COMPONENTE AGREGADOR \texttt{MÓDULO OPTATIVO} (\texttt{FEELT!OPT}) CADASTRADO NA ABA \texttt{COMPONENTES}, EVITANDO MANTER O MESMO VALOR EM DOIS LUGARES. CONFIRME SE \textbf{\input{gerado/par_carga_horaria_optativa}} É, DE FATO, O VALOR PRETENDIDO PELO NDE/COLEGIADO PARA ESTE CURSO — O QUADRO ACIMA JÁ LISTA 16 COMPONENTES OPTATIVOS REAIS (930H DISPONÍVEIS). ADICIONALMENTE, OS SETE COMPONENTES \texttt{FEELT!RASC1} A \texttt{FEELT!RASC7} ESTÃO CADASTRADOS SEM A DENOMINAÇÃO DA DISCIPLINA (NOME ATUAL: ``RASC Nº:'', SEM TEXTO APÓS OS DOIS-PONTOS) — PENDENTE DE COMPLEMENTAÇÃO PELO NDE/COLEGIADO ANTES DA SUBMISSÃO DESTE PPC]}
...
\section{Mobilidade Acadêmica, Internacionalização e Estudos em Outras Instituições}
\label{sec:mobilidade}

O \ppccurso reconhece a mobilidade acadêmica nacional e internacional, bem como a realização pontual de componentes curriculares em outras instituições de ensino superior, como instrumentos legítimos de flexibilização, enriquecimento e internacionalização da formação do(a) estudante. Essas possibilidades ampliam o contato com diferentes metodologias de ensino, laboratórios e ecossistemas de automação, robótica, inteligência artificial e sistemas embarcados, contribuindo para uma formação interdisciplinar, cientificamente atualizada e preparada para a atuação em ambientes tecnológicos globais -- sem, no entanto, dispensar o cumprimento integral da carga horária e dos objetivos formativos definidos por este PPC.

\subsection{Mobilidade Acadêmica Nacional}

A mobilidade acadêmica nacional possibilita ao(à) estudante regularmente matriculado(a) realizar, temporariamente, atividades de ensino, pesquisa e extensão em outra Instituição Federal de Ensino Superior brasileira, no âmbito do Programa ANDIFES de Mobilidade Acadêmica, mantendo seu vínculo com a UFU~\cite{ufu_congrad_08_2004,ufu_congrad_13_2013}. Sua realização depende de convênio vigente, da existência de vaga na instituição de destino e da observância dos requisitos, prazos e procedimentos estabelecidos pelas normas institucionais da UFU e, quando cabível, por norma complementar do curso (Seção~\ref{sec:norma_complementar_mobilidade}). Cumpridos esses requisitos, os componentes curriculares cursados em mobilidade nacional poderão ser incorporados ao percurso acadêmico do(a) estudante, nos termos da Seção~\ref{sec:mobilidade_aproveitamento}.

\subsection{Mobilidade Acadêmica Internacional}

A mobilidade acadêmica internacional possibilita ao(à) estudante regularmente matriculado(a) realizar, durante determinado período da graduação, componentes curriculares e demais atividades acadêmicas em instituição de ensino superior estrangeira, nos termos dos acordos de cooperação vigentes e da regulamentação institucional da UFU~\cite{ufu_congrad_112_2023}. A participação depende de seleção prévia, plano de estudos aprovado pela Coordenação do Curso e observância dos prazos e da documentação estabelecidos pela Diretoria de Relações Internacionais e Interinstitucionais (DRII). O(a) estudante mantém, durante toda a mobilidade, seu vínculo com a UFU, e os componentes cursados no exterior poderão ser incorporados ao percurso acadêmico nos termos da Seção~\ref{sec:mobilidade_aproveitamento}.

\subsection{Realização de Componentes Curriculares em Outras Instituições}

Independentemente de participação em programa formal de mobilidade, o(a) estudante regularmente matriculado(a) no \ppccurso pode, mediante autorização prévia da Coordenação do Curso, cursar componente curricular isolado em outra instituição de ensino superior e, posteriormente, requerer seu aproveitamento para a integralização curricular, nos termos das Normas Gerais da Graduação da UFU~\cite{ufu_congrad_46_2022}. Essa possibilidade preserva o vínculo regular do(a) estudante com a UFU durante todo o período e está sujeita aos limites, critérios e procedimentos fixados pela regulamentação institucional vigente e, no que for delegável, por norma complementar do curso (Seção~\ref{sec:norma_complementar_mobilidade}).

\subsection{Aproveitamento dos Estudos Realizados}
\label{sec:mobilidade_aproveitamento}

O aproveitamento de componentes curriculares cursados em outra instituição -- em mobilidade nacional, em mobilidade internacional ou de forma isolada -- ocorre por reconhecimento de equivalência, mediante comparação de carga horária e conteúdo programático, e produz o cumprimento do componente curricular equivalente sem efeito sobre os indicadores de rendimento acadêmico do(a) estudante, conforme as Normas Gerais da Graduação da UFU~\cite{ufu_congrad_46_2022}. Quando o componente cursado externamente contribuir para a formação do(a) estudante sem equivalência direta a um componente do fluxo curricular, seu reconhecimento como Atividade Acadêmica Complementar permanece disponível, nos limites da Seção~\ref{sec:AAC}.

\subsection{Regulamentação Complementar}
\label{sec:norma_complementar_mobilidade}

Os procedimentos operacionais relativos à mobilidade acadêmica e aos estudos realizados em outras instituições -- documentação, prazos, critérios de análise e demais aspectos não reservados à regulamentação do CONGRAD -- poderão ser detalhados em norma complementar do curso, proposta pelo Colegiado de Curso e aprovada pelo Conselho da Faculdade de Engenharia Elétrica, nos termos do art. 207 das Normas Gerais da Graduação da UFU~\cite{ufu_congrad_46_2022}, sem prejuízo da aplicação direta e imediata das normas institucionais vigentes enquanto tal norma complementar não for editada.
