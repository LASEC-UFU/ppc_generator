...
Mobilidade acadêmica nacional (Seção~\ref{sec:mobilidade}) & Programa ANDIFES & \url{https://prograd.ufu.br/mobilidadenacional}\\
Mobilidade acadêmica internacional (Seção~\ref{sec:mobilidade}) & Diretoria de Relações Internacionais e Interinstitucionais (DRII) & \url{https://dri.ufu.br/}\\
