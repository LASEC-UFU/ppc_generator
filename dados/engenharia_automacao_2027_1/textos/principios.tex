...
O \ppccurso da Universidade Federal de Uberlândia é orientado por princípios que articulam a excelência técnica com a responsabilidade social, a aplicação prática com a criticidade, e a formação profissionalizante com a ética. Tais princípios refletem os compromissos institucionais da UFU, as Diretrizes Curriculares Nacionais do Curso de Graduação em Engenharia~\cite{cne_ces_2_2019,cne_ces_1_2021} e os desafios da formação de engenheiros(as) para a indústria automatizada do século XXI.

Entre os fundamentos que estruturam o presente Projeto Pedagógico do Curso, destacam-se:

\begin{itemize}
    \item Formação em engenharia aplicada e profissionalizante, com domínio técnico-científico das tecnologias de automação industrial, articulado à capacidade crítica de compreender e intervir no ambiente produtivo de forma ética e responsável;
...
Esses princípios orientam as decisões curriculares, metodológicas e avaliativas do curso, guiando a formação de \ppctitulacao(s) capazes de atuar de forma crítica, aplicada e transformadora nos diversos contextos em que a automação industrial se insere.
