...
\begin{itemize}
    \item \textbf{carga horária total de optativas} — \textbf{\input{gerado/par_carga_horaria_optativa}}, lida diretamente do componente agregador \texttt{MÓDULO OPTATIVO} cadastrado (inativo) na aba \texttt{Componentes} da matriz curricular — sem duplicar esse valor na aba \texttt{Perfil} —, exigida para a integralização curricular do curso como um todo (\autoref{chp:estrutura_curricular});
