...
Se a proposta de ABI for aprovada (\autoref{chp:abi}), o acompanhamento de egressos poderá diferenciar, conforme os mecanismos efetivamente regulamentados, os seguintes perfis:

\begin{itemize}
    \item egressos que concluíram o \ppccurso;
    \item egressos que, com base em futuro ato institucional, obtiveram autorização para iniciar a outra graduação (\autoref{sec:permanencia}); e
    \item egressos que concluíram ambas as graduações, se essa continuidade vier a ser instituída (\autoref{sec:diplomas}).
\end{itemize}

Este PPC concentra seu acompanhamento no perfil profissional do(a) \ppctitulacao (\autoref{chp:perfil_egresso}), próprio deste curso, sem ignorar a possibilidade de continuidade acadêmica no Curso Superior de Tecnologia em Automação Industrial: os egressos que optarem por essa continuidade são acompanhados também quanto a essa trajetória, mas o acompanhamento do perfil profissional específico do Curso Superior de Tecnologia em Automação Industrial é tratado no respectivo PPC.
